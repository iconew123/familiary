    ...
    return (
        ...
        >
            ...
            <GridItem area={'main'} bg='#FFFEF0  ' display="flex" flexDirection="column" alignItems="center" padding="20px">
                <Text fontSize="3xl" mb="20px">임신 초기 이해</Text>
                ...
                <Box>
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 3주차</Text>
                    <Text mb="10px">
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 4주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 5주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 6주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 7주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 8주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 9주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 10주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 11주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 12주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
                    ...
                    <Text fontSize="2xl" mb="10px" color="#85662C ">|임신 13주차</Text>
                    <Text mb="10px">
                        <strong>1. 태아의 성장</strong><br />
