    ...
    return (
        ...
        >
            ...
            <GridItem area={'main'} bg='#FFFEF0  ' display="flex" flexDirection="column" alignItems="center" padding="20px">
                <Text fontFamily="'Nanum Gothic', cursive" fontSize="3xl" mb="20px">임신 중기 생활 습관</Text>

                <Box>
                    <Text fontFamily="'Nanum Gothic', cursive" fontSize="3xl" mb="10px">영양 및 체중관리</Text>
                    <Text fontFamily="'Nanum Gothic', cursive"  fontSize="2xl" mb="10px" color="#85662C ">|영양</Text>
                    ...
                    <Text fontFamily="'Nanum Gothic', cursive" fontSize="2xl" mb="10px" color="#85662C ">|체중관리</Text>
                    <Text fontFamily="'Nanum Gothic', cursive" mb="10px">
